...
//     var today = mm + '/' + dd + '/' + yyyy;
    ...
    var receiveBy = "";
    if(data.facetoface ==="Yes"){
        receiveBy = receiveBy+'Face to Face' ;
    }
    if(data.telephone ==="Yes"){
        receiveBy = receiveBy+' , Telephone' ;
    } 
                        ...
                        '<td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">'+
                            ...
                            '<table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #fff;border: 3px outset #61c4ee;">'+
                                '<tbody><tr> <td valign="top" class="mcnTextContent" style="padding: 18px;color: #534A4A;font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;font-size: 14px;font-weight: normal;line-height: 180%;text-align: center;">'+
                                        '<table> <tbody> <tr> <td>'+
                                            '<p style="color: #534A4A;font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;font-size: 14px;font-weight: normal;line-height: 180%;text-align: center;">&nbsp;<img data-file-id="5426324" height="80" src="https://mcusercontent.com/3f49016a50f65bc965e36930d/images/5f4d76c0-2a5d-45cc-93f4-a9098ba557e2.png" style="border: 0px  ; width: 220px; height: 62px; margin: 0px;" width="433"><br></p>'+
                                            ...
                                            '<p style="color: #534A4A;font-family: Lato, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;font-size: 16px;font-weight: normal;line-height: 180%;text-align: left;"> <strong>Preferred Consultation :</strong> '+receiveBy+'  </p>'+
